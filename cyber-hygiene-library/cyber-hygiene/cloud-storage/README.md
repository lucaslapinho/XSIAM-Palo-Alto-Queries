# Cloud Storage / File Synchronization — inventory review candidates

[Query](detect-cloud-storage-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
