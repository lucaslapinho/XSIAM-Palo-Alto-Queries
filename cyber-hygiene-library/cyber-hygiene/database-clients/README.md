# Database Clients — inventory review candidates

[Query](detect-database-clients-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
