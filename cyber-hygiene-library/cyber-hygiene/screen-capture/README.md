# Screen Recording / Capture — inventory review candidates

[Query](detect-screen-capture-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
