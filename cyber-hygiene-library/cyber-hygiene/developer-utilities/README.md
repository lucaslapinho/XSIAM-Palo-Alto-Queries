# Developer Utilities — inventory review candidates

[Query](detect-developer-utilities-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
