# Other Corporate-Risk / Shadow-IT Applications — inventory review candidates

[Query](detect-other-shadow-it-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
