# Scripting / Automation Tools — inventory review candidates

[Query](detect-scripting-automation-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
