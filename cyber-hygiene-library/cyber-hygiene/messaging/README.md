# Communication / Messaging — inventory review candidates

[Query](detect-messaging-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
...
Return application-inventory rows matching **5 catalog products / 7 full-name candidates**, using primary category ownership only. This supports corporate software review. A reported label does not prove identity, execution, sessions, current installation, unauthorized software, protection health or compromise.
