# System Administration Tools — inventory review candidates

[Query](detect-system-administration-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
