# Penetration Testing / Dual-Use Security Tools — inventory review candidates

[Query](detect-penetration-testing-tools.xql) · [Metadata](query-metadata.yaml) · [Catalog](../../catalog/software-catalog.yaml)
