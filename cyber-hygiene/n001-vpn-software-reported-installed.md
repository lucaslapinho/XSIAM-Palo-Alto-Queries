# VPN Software - Reported Installed

Identifies candidate vpn products in the latest nonempty application report per endpoint available through host_inventory_applications during the selected window. Returns product, reported vendor, version and inventory age context for software-policy review; a report is not proof of current presence or execution.

[Open query](n001-vpn-software-reported-installed.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N001  
**Category:** Cyber Hygiene / VPN  
