...
| comp count_distinct(endpoint_id) as distinct_endpoint_count,
       values(endpoint_name) as endpoint_names,
       max(report_timestamp) as newest_report
    by tool_family, detected_product
| filter distinct_endpoint_count <= 3
