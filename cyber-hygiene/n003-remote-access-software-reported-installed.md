# Remote Access Software - Reported Installed

Identifies candidate remote access products in the latest nonempty application report per endpoint available through host_inventory_applications during the selected window. Returns product, reported vendor, version and inventory age context for software-policy review; a report is not proof of current presence or execution.

[Open query](n003-remote-access-software-reported-installed.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N003  
**Category:** Cyber Hygiene / Remote Access  
