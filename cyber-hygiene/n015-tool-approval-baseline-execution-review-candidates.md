# Tool Approval Baseline - Execution Review Candidates

Lists matched products from xdr_data process starts outside an analyst-supplied product approval list. The shipped sentinel approves nothing, so all matched products remain unclassified review candidates until the SOC supplies a scoped policy; this query does not declare software unauthorized.

[Open query](n015-tool-approval-baseline-execution-review-candidates.xql) · [Category index](README.md) · [Library](../README.md)
