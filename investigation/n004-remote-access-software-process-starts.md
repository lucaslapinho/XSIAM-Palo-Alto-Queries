# Remote Access Software - Process Starts

Finds xdr_data process-start rows whose image names match documented Windows remote access executable artifacts. Returns host, users, image, command line, initiating process and signature context for investigation; matching a tool does not establish maliciousness, a network session or policy violation.

[Open query](n004-remote-access-software-process-starts.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N004  
**Category:** Investigation / Remote Access  
