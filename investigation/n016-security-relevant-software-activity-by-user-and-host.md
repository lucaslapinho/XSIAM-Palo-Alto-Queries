# Security-Relevant Software - Activity by User and Host

Aggregates matched xdr_data process-start rows by process user, endpoint and product, retaining first/last observations. Supports account and endpoint investigations; the process username is not automatically the initiating or interactive user.

[Open query](n016-security-relevant-software-activity-by-user-and-host.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N016  
**Category:** Investigation / User Activity  
