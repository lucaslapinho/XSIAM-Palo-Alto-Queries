...
| filter process_name in ("aws vpn client.exe", "aws-client-vpn-daemon.exe", "aws-vpn-client.exe", "cloudflare warp.exe", "forticlient.exe", "fortisslvpndaemon.exe", "mullvad-daemon.exe", "nordvpn.exe", "openvpn-gui.exe", "openvpn.exe", "pangpa.exe", "pangps.exe", "protonvpn.client.exe", "protonvpn.launcher.exe", "protonvpn.wireguardservice.exe", "protonvpnservice.exe", "tailscale-ipn.exe", "tailscale.exe", "tailscaled.exe", "twingate.exe", "twingate.service.exe", "twingateupdater.exe", "vpncli.exe", "vpnui.exe", "warp-svc.exe", "wireguard.exe")
