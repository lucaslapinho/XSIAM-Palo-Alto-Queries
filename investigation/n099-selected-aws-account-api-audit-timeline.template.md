# Selected AWS Account API Audit Timeline
...
[Open query](n099-selected-aws-account-api-audit-timeline.template.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N099  
**Category:** Investigation / AWS Audit  
...
|---|---|---|
| `{{AWS_ACCOUNT_TO_REVIEW}}` | Quoted STRING literal | Quoted STRING literal: one 12-digit AWS account in the collected scope. |
...
|---|---|---|
| Planned test | Positive: collected operation for the selected account is retained with error context. | See scenario |
| Planned test | Negative: another recipient account is excluded. | See scenario |
| Planned test | Null: absent session issuer remains null for non-role identities. | See scenario |
| Planned test | Edge: management/data categories stay visible rather than implying complete coverage. | See scenario |
