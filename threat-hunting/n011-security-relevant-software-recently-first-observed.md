# Security-Relevant Software - Recently First Observed

Finds host/product combinations whose earliest matched xdr_data process-start observation in the 30-day lookback falls within the last 24 hours. Supports change review and new-activity hunting; collection onset or retention gaps can create the same pattern, and this does not mean first-ever execution.

[Open query](n011-security-relevant-software-recently-first-observed.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N011  
**Category:** Threat Hunting / Newly Observed Software  
