# Remote Access Software - Unsigned Process Starts

Finds matched remote-access process-start rows in xdr_data with signature status 3, the documented unsigned state. Returns event context for identity verification; failed, unknown or invalid signature states are distinct, and unsigned software may be legitimate.

[Open query](n017-remote-access-software-unsigned-process-starts.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N017  
**Category:** Threat Hunting / Remote Access  
