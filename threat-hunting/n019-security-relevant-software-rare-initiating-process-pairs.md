# Security-Relevant Software - Rare Initiating Process Pairs

Aggregates matched xdr_data process-start rows by candidate tool and initiating process image, retaining pairs present on at most two endpoints. Supports ancestry review against peer baselines; initiating actor fields and causality fields are distinct, and rare pairs often reflect legitimate automation.

[Open query](n019-security-relevant-software-rare-initiating-process-pairs.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N019  
**Category:** Threat Hunting / Process Relationships  
