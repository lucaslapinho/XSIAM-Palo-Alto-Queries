# Security-Relevant Software - User-Writable Path Candidates

Finds matched xdr_data process-start rows whose image paths contain Windows AppData, Downloads or Temp directory segments. These path heuristics support portable-tool review; they do not inspect ACLs or prove a directory is writable by the observed user.

[Open query](n018-security-relevant-software-user-writable-path-candidates.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N018  
**Category:** Threat Hunting / Execution Paths  
