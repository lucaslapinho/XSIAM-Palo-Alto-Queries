# Cortex Management Audit Timeline
...
[Open query](n094-cortex-management-audit-timeline.xql) · [Category index](README.md) · [Library](../README.md)
...
|---|---|---|
| Planned test | Positive: success and failure records both remain with raw result. | See scenario |
| Planned test | Negative: records outside the one-day window are excluded. | See scenario |
| Planned test | Null: absent actor/host remains visible rather than relabeled. | See scenario |
| Planned test | Edge: different categories at the same timestamp remain separate rows. | See scenario |
