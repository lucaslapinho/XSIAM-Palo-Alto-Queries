# Security-Relevant Software - Inventory Distribution

Aggregates candidate VPN, remote-access and dual-use products from the latest nonempty application reports in host_inventory_applications. Counts distinct endpoint IDs per product, reported vendor and version to support deployment reviews without interpreting inventory rows as executions.

[Open query](n007-security-relevant-software-inventory-distribution.xql) · [Category index](README.md) · [Library](../README.md)
