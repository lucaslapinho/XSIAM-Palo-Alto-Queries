# Security-Relevant Software - Execution Distribution

Summarizes matched xdr_data process-start rows by tool family and candidate product, with event-row counts, distinct endpoint IDs and first/last observations. Supports software visibility dashboards; frequencies are telemetry-row counts and not unique sessions.

[Open query](n008-security-relevant-software-execution-distribution.xql) · [Category index](README.md) · [Library](../README.md)

**ID:** N008  
**Category:** Dashboard / Software Execution  
